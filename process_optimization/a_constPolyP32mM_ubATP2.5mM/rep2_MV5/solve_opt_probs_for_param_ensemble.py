...
""" Description
    -----------
    Target function: max [UDP-GalNAc at 7h]
    Opt. variables: all initial enzyme and substrate concentrations
    Constraints: E_tot_after <= E_tot_before
    Method: Genetic Algorithm (default settings)
"""
# solve optimization problem
result_file_name = "ImpExtSearch_v23b_rep2_MV5_PartSwarm50x_OP01withS_7h.pkl"
opt_results = solve_OP01withS_7h(model_path, fits_data_path, result_file_name)
