...
reading_file = open('SSO_ImpExtSearch_v23b_onlyAICc_output_dict', 'rb')
...
# output: "Model variant 17 with best median rank 1.0 and best mean rank 1.0 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_onlyAICc_ModelVar17'
