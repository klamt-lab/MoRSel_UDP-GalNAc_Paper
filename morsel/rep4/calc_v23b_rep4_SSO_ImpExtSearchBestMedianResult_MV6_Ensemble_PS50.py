...
reading_file = open('SSO_ImpExtSearch_v23b_rep4_output_dict', 'rb')
...
# output: "Model variant 6 with best median rank 7.0 and best mean rank 8.166666666666666 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_rep4_ModelVar6'
