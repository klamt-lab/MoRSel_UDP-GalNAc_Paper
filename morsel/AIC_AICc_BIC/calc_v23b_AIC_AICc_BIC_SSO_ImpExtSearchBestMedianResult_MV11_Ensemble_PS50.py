...
reading_file = open('SSO_ImpExtSearch_v23b_AIC_AICc_BIC_output_dict', 'rb')
...
# output: "Model variant 11 with best median rank 3.0 and best mean rank 3.0 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_AIC_AICc_BIC_ModelVar11'
