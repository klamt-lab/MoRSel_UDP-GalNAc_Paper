...
## v22 requires new neg control start ensemble since P_Inhib is already included!
...
## v22: start variant includes P_Inhib terms for all enzyme-catalyzed reactions
# set model name
model_variant_name = 'v23bAIC_AICc_BICNegControl_Exp36.37.39'
n_runs = 50
...
## v22: remove P_Inhib variable terms from list; also: no variable terms change any entry in column 'term1' (col idx 1)
## v23: add ADP_Inhib as potential regulation to all enzyme-catalyzed reactions (my own hypothesis, no literature source)
...
reading_file = open('v23bAIC_AICc_BICNegControl_Exp36.37.39_50runs_evaluated_vars_log', 'rb')
...
storage_file = open('SSO_ImpExtSearch_v23b_AIC_AICc_BIC_output_dict', 'wb')
