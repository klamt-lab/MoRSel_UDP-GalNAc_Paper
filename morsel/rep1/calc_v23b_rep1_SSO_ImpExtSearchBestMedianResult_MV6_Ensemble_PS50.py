...
reading_file = open('SSO_ImpExtSearch_v23b_rep1_output_dict', 'rb')
...
# output: "Model variant 6 with best median rank 7.5 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_rep1_ModelVar6'
