...
# set model name
model_variant_name = 'v23bonlyAICNegControl_Exp36.37.39'
n_runs = 50
...
reading_file = open('v23bonlyAICNegControl_Exp36.37.39_50runs_evaluated_vars_log', 'rb')
...
storage_file = open('SSO_ImpExtSearch_v23b_onlyAIC_output_dict', 'wb')
