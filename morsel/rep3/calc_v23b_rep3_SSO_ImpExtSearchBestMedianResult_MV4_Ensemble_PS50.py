...
reading_file = open('SSO_ImpExtSearch_v23b_rep3_output_dict', 'rb')
...
# output: "Model variant 4 with best median rank 6.0 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_rep3_ModelVar4'
