...
reading_file = open('SSO_ImpExtSearch_v23b_onlyCIC3_output_dict', 'rb')
...
# output: "Model variant 2 with best median rank 1.0 and best mean rank 1.0 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_onlyCIC3_ModelVar2'
