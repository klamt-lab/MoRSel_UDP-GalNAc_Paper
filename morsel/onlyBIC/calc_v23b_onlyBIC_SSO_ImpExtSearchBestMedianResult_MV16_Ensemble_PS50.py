...
reading_file = open('SSO_ImpExtSearch_v23b_onlyBIC_output_dict', 'rb')
...
# output: "Model variant 16 with best median rank 1.0 and best mean rank 1.0 was selected."
...
model_variant_name = 'ImpExtSearch_v23b_onlyBIC_ModelVar16'
